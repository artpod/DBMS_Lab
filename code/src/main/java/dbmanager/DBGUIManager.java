...
class DBGUIManager extends JFrame {
    ...
    DBGUIManager() {
        super("СУБД Підгорний А.Ю. ТТП-41");

        this.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        this.setSize(1600, 1000);
        this.getContentPane().setBackground(Color.cyan);
        this.getContentPane().add(BorderLayout.NORTH, initializeMenuBar()).setBackground(Color.cyan);
        this.getContentPane().add(BorderLayout.WEST, initializeMenuPanel()).setBackground(Color.cyan);
        this.getContentPane().add(BorderLayout.CENTER, initializeResultPanel()).setBackground(Color.cyan);
        ;
        this.getContentPane().add(BorderLayout.SOUTH, initializeControlPanel()).setBackground(Color.cyan);
        ;
    }
    ...
    private JMenuBar initializeMenuBar() {
        ...
        menuAbout.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Made by Pidgornyi Artem, TTP-41, Cybernetics");
        });
